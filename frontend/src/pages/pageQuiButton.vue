  ...
  <div id="pageQuiButton">
    <div class="mod-module mod-btn">
      <p class="btn-bar text-r">
        <qui-btn v-on:btnClickEvent="bCE" msg="确定1" class="small"></qui-btn>
      </p>
      <p class="btn-bar text-r">
        <qui-btn msg="确定1,2" class="small bor"></qui-btn>
      </p>
      <p class="btn-bar text-r">
        <qui-btn msg="下载1" class="small icon">
      ...
      <p class="btn-bar bar-flex">
        ...
        <qui-btn v-on:btnClickEvent="doTheClick" msg="我可以点击" class="middle bg"></qui-btn>
      </p>
    </div>
  </div>
</template>
